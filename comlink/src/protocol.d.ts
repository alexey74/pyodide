...
export declare type WireValue = RawWireValue | HandlerWireValue | IdWireValue;
export declare type MessageID = string;
export declare type StoreKey = number;
...
export declare type Message = GetMessage | SetMessage | ApplyMessage | ConstructMessage | EndpointMessage | ReleaseMessage | DestroyMessage;
